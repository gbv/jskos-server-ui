...
[![GitHub release](https://img.shields.io/github/v/release/gbv/jskos-server-ui?logo=github&logoColor=white&label=release&sort=semver)](https://github.com/gbv/jskos-server-ui/releases/latest)
